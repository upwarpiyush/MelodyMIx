...
const AudioPlayer = ({ currentTrack, currentIndex, setCurrentIndex, total}) => {
  ...
  return (
    <div className='w-[100%] h-[44%]  mx-[3%] flex'>
      {/* //left Part */}
        ...
        <div className='w-[63%] flex flex-col justify-evenly items-center '>
          ...
          <p className='text-cyan-700 text-md font-semibold'>{artists.join(' | ')}</p>
          <div className='flex flex-col items-center w-[100%]'>
            <div className='w-[50%] flex justify-between items-center mb-[20px]'>
              <p className='text-lg font-semibold m-0 text-cyan-200'>0:{addZero(Math.round(trackProgress))}</p>
